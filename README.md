...
- If you use videos to run Colmap and the number of frames is too high (i.e., the videos are too long), you can first use FFmpeg to reduce the fps of the videos before using Colmap.
