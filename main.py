...
@click.option('--factor', type=int, default=1)
...
@click.option("--i_print", type=int, default=1000, help='frequency of console printout and metric loggin')
@click.option("--train_image_log_step", type=int, default=500, help='frequency of tensorboard image logging')
@click.option("--i_weights", type=int, default=1000, help='frequency of weight ckpt saving')
@click.option("--i_save_rendering", type=int, default=1000, help='frequency of weight ckpt saving')
@click.option("--i_testset", type=int, default=1000, help='frequency of testset saving')
@click.option("--i_video", type=int, default=10000, help='frequency of render_poses video saving')
def main(**kwargs):
